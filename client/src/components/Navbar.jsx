...
export default function Navbar() {
  ...
  return (
    // 🌌 Full-Width Sticky Header Box - Covers screen from end to end
    <nav className="sticky top-0 z-50 w-full bg-slate-950 border-b border-slate-800/80 px-4 py-3 md:px-8 shadow-[0_4px_25px_rgba(0,0,0,0.4)] transition-all duration-300">
      
      {/* 🎆 Premium Neon Top Border */}
      <div className="absolute top-0 left-0 w-full h-[1.5px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-100"></div>

      <div className="max-w-6xl mx-auto flex justify-between items-center relative z-10">
        
        {/* ⚡ Crystal Clear Logo Section */}
        <Link 
          to="/" 
        ...
        {/* 🎛️ Action Buttons with Perfect Visual Contrast */}
        <div className="flex gap-3 items-center">
          {seller ? (
            <>
              {/* * Mobile par naam mat dikhao * */}
              <div className="hidden lg:flex items-center gap-2 bg-slate-900 border border-slate-800 rounded-xl px-3 py-1.5 shadow-inner">
